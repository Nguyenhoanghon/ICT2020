...
(function (t) {
  ...
  }var o = Array.prototype.slice;'function' == typeof define && define.amd ? define('jquery-bridget/jquery.bridget', ['jquery'], i) : i(t.jQuery);
})(window), function (t) {
  function e(e) {
  ...
  });var r = { bind: o, unbind: n };'function' == typeof define && define.amd ? define('eventie/eventie', r) : 'object' == typeof exports ? module.exports = r : t.eventie = r;
}(this), function (t) {
  function e(t) {
    'function' == typeof t && (e.isReady ? t() : r.push(t));
  }function i(t) {
    var i = 'readystatechange' === t.type && 'complete' !== n.readyState;if (!e.isReady && !i) {
      e.isReady = !0;for (var o = 0, s = r.length; s > o; o++) {
        var a = r[o];a();
      }
    }
  }function o(o) {
    return o.bind(n, 'DOMContentLoaded', i), o.bind(n, 'readystatechange', i), o.bind(t, 'load', i), e;
      ...
      r = [];e.isReady = !1, 'function' == typeof define && define.amd ? (e.isReady = 'function' == typeof requirejs, define('doc-ready/doc-ready', ['eventie/eventie'], o)) : t.docReady = o(t.eventie);
}(this), function () {
  ...
  function e(t) {
    ...
    function o(t) {
      if ('string' == typeof t && (t = document.querySelector(t)), t && 'object' == typeof t && t.nodeType) {
        var o = r(t);if ('none' === o.display) return i();var n = {};n.width = t.offsetWidth, n.height = t.offsetHeight;for (var h = n.isBorderBox = !(!p || !o[p] || 'border-box' !== o[p]), f = 0, c = s.length; c > f; f++) {
          var d = s[f],
              l = o[d];l = a(t, l);var y = parseFloat(l);n[d] = isNaN(y) ? 0 : y;
            ...
            z = h && u,
            S = e(o.width);S !== !1 && (n.width = S + (z ? 0 : m + I));var b = e(o.height);return b !== !1 && (n.height = b + (z ? 0 : g + L)), n.innerWidth = n.width - (m + I), n.innerHeight = n.height - (g + L), n.outerWidth = n.width + v, n.outerHeight = n.height + _, n;
      }
    }function a(t, e) {
      if (n || -1 === e.indexOf('%')) return e;var i = t.style,
          o = i.left,
          r = t.runtimeStyle,
          s = r && r.left;return s && (r.left = t.currentStyle.left), i.left = e, e = i.pixelLeft, i.left = o, s && (r.left = s), e;
    }var u,
        p = t('boxSizing');return function () {
      if (p) {
        var t = document.createElement('div');t.style.width = '200px', t.style.padding = '1px 2px 3px 4px', t.style.borderStyle = 'solid', t.style.borderWidth = '1px 2px 3px 4px', t.style[p] = 'border-box';var i = document.body || document.documentElement;i.appendChild(t);var o = r(t);u = 200 === e(o.width), i.removeChild(t);
      }
    }(), o;
  ...
  function i(t, e) {
    ...
    o(t);for (var i = t.parentNode.querySelectorAll(e), n = 0, r = i.length; r > n; n++) if (i[n] === t) return !0;return !1;
  }function r(t, e) {
    return o(t), i(t, e);
  }var s,
      a = function () {
    if (e.matchesSelector) return 'matchesSelector';for (var t = ['webkit', 'moz', 'ms', 'o'], i = 0, o = t.length; o > i; i++) {
      var n = t[i],
          r = n + 'MatchesSelector';if (e[r]) return r;
    }
  }();if (a) {
    var u = document.createElement('div'),
        p = i(u, 'div');s = p ? i : r;
  } else s = n;'function' == typeof define && define.amd ? define('matches-selector/matches-selector', [], function () {
    return s;
  ...
  function e(t, e) {
    ...
    function m(t, i) {
      if ('string' == typeof t && (t = a.querySelector(t)), !t || !c(t)) return u && u.error('Bad ' + this.constructor.namespace + ' element: ' + t), void 0;this.element = t, this.options = e({}, this.constructor.defaults), this.option(i);var o = ++g;this.element.outlayerGUID = o, v[o] = this, this._create(), this.options.isInitLayout && this.layout();
    }var g = 0,
      ...
      t = o(t);for (var e = this.options.itemSelector, i = [], n = 0, r = t.length; r > n; n++) {
        var s = t[n];if (c(s)) if (e) {
          l(s, e) && i.push(s);for (var a = s.querySelectorAll(e), u = 0, p = a.length; p > u; u++) i.push(a[u]);
        } else i.push(s);
      }return i;
      ...
      var i,
          o = this.options[t];o ? ('string' == typeof o ? i = this.element.querySelector(o) : c(o) && (i = o), this[t] = i ? d(i)[e] : o) : this[t] = 0;
      ...
      function o() {
        ...
        for (var e = r(t), i = a.querySelectorAll('.js-' + e), n = 'data-' + e + '-options', s = 0, h = i.length; h > s; s++) {
          var f,
              c = i[s],
              d = c.getAttribute(n);try {
            f = d && JSON.parse(d);
          } catch (l) {
            u && u.error('Error parsing ' + n + ' on ' + c.nodeName.toLowerCase() + (c.id ? '#' + c.id : '') + ': ' + l);continue;
          }var y = new o(c, f);p && p.data(c, t, y);
        }
  ...
  function e(t) {
    var e = t.create('fitRows');return e.prototype._resetLayout = function () {
      ...
      t.getSize(), 0 !== this.x && t.size.outerWidth + this.x > this.isotope.size.innerWidth && (this.x = 0, this.y = this.maxY);var e = { x: this.x, y: this.y };return this.maxY = Math.max(this.maxY, this.y + t.size.outerHeight), this.x += t.size.outerWidth, e;
  ...
  function e(t, e) {
    ...
    function f(t, e) {
    ...
    }var c = t.create('isotope', { layoutMode: 'masonry', isJQueryFiltering: !0, sortAscending: !0 });c.Item = u, c.LayoutMode = h, c.prototype._create = function () {
      ...
      var t = this.options.getSortData;for (var e in t) {
        var i = t[e];this._sorters[e] = d(i);
      }
    }, c.prototype._updateItemsSortData = function (t) {
      for (var e = 0, i = t.length; i > e; e++) {
        var o = t[e];o.updateSortData();
      }
    };var d = function () {
      function t(t) {
        if ('string' != typeof t) return t;var i = a(t).split(' '),
            ...
            r = n && n[1],
            s = e(r, o),
            u = c.sortDataParsers[i[1]];return t = u ? function (t) {
          return t && u(s(t));
        } : function (t) {
          return t && s(t);
        };
    ...
    };var l = c.prototype.remove;return c.prototype.remove = function (t) {
      t = o(t);var e = this.getItems(t);if (l.call(this, t), e && e.length) for (var i = 0, r = e.length; r > i; i++) {
...
!function (a, b) {
  ...
  function a(b) {
    for (var c in a.defaults) this[c] = a.defaults[c];for (c in b) this[c] = b[c];
  }a.defaults = { x: 0, y: 0, width: 0, height: 0 };var b = a.prototype;return b.contains = function (a) {
    var b = a.width || 0,
        c = a.height || 0;return this.x <= a.x && this.y <= a.y && this.x + this.width >= a.x + b && this.y + this.height >= a.y + c;
  }, b.overlaps = function (a) {
    var b = this.x + this.width,
        c = this.y + this.height,
        d = a.x + a.width,
        e = a.y + a.height;return this.x < d && b > a.x && this.y < e && c > a.y;
  }, b.getMaximalFreeRects = function (b) {
    if (!this.overlaps(b)) return !1;var c,
        d = [],
        e = this.x + this.width,
  ...
  if ('function' == typeof define && define.amd) define('packery/js/packer', ['./rect'], b);else if ('object' == typeof module && module.exports) module.exports = b(require('./rect'));else {
    var c = a.Packery = a.Packery || {};c.Packer = b(c.Rect);
  }
}(window, function (a) {
  function b(a, b, c) {
    this.width = a || 0, this.height = b || 0, this.sortDirection = c || 'downwardLeftToRight', this.reset();
  }var c = b.prototype;c.reset = function () {
    this.spaces = [];var b = new a({ x: 0, y: 0, width: this.width, height: this.height });this.spaces.push(b), this.sorter = d[this.sortDirection] || d.downwardLeftToRight;
  }, c.pack = function (a) {
    for (var b = 0; b < this.spaces.length; b++) {
      var c = this.spaces[b];if (c.canFit(a)) {
        this.placeInSpace(a, c);break;
      }
    }
  }, c.columnPack = function (a) {
    for (var b = 0; b < this.spaces.length; b++) {
      var c = this.spaces[b],
          d = c.x <= a.x && c.x + c.width >= a.x + a.width && c.height >= a.height - .01;if (d) {
        a.y = c.y, this.placed(a);break;
      }
    }
  }, c.rowPack = function (a) {
    for (var b = 0; b < this.spaces.length; b++) {
      var c = this.spaces[b],
          d = c.y <= a.y && c.y + c.height >= a.y + a.height && c.width >= a.width - .01;if (d) {
        a.x = c.x, this.placed(a);break;
      }
    }
    ...
    for (var b = [], c = 0; c < this.spaces.length; c++) {
      var d = this.spaces[c],
          e = d.getMaximalFreeRects(a);e ? b.push.apply(b, e) : b.push(d);
    ...
    var b = 0,
      ...
      for (var d = 0, e = a[b + d]; e;) {
        if (e == c) d++;else {
          if (e.contains(c)) {
            a.splice(b, 1), c = a[b];continue a;
          }c.contains(e) ? a.splice(b + d, 1) : d++;
        }e = a[b + d];
      }b++, c = a[b];
    }return a;
  };var d = { downwardLeftToRight: function (a, b) {
  ...
  var c = document.documentElement.style,
    ...
    a.Item.apply(this, arguments);
      ...
      g = f._create;f._create = function () {
    g.call(this), this.rect = new b();
  };var h = f.moveTo;return f.moveTo = function (a, b) {
    var c = Math.abs(this.position.x - a),
        d = Math.abs(this.position.y - b),
        e = this.layout.dragItemCount && !this.isPlacing && !this.isTransitioning && 1 > c && 1 > d;return e ? void this.goTo(a, b) : void h.apply(this, arguments);
    ...
    var a = this.dropPlaceholder;a || (a = this.dropPlaceholder = document.createElement('div'), a.className = 'packery-drop-placeholder', a.style.position = 'absolute'), a.style.width = this.size.width + 'px', a.style.height = this.size.height + 'px', this.positionDropPlaceholder(), this.layout.element.appendChild(a);
  ...
  function f(a, b) {
    ...
    var c = b.x - a.x,
        d = b.y - a.y;return Math.sqrt(c * c + d * d);
  }c.prototype.canFit = function (a) {
    return this.width >= a.width - 1 && this.height >= a.height - 1;
  };var i = b.create('packery');i.Item = e;var j = i.prototype;j._create = function () {
    b.prototype._create.call(this), this.packer = new d(), this.shiftPacker = new d(), this.isEnabled = !0, this.dragItemCount = 0;var a = this;this.handleDraggabilly = { dragStart: function () {
        a.itemDragStart(this.element);
      }, dragMove: function () {
        a.itemDragMove(this.element, this.position.x, this.position.y);
      }, dragEnd: function () {
        a.itemDragEnd(this.element);
      } }, this.handleUIDraggable = { start: function (b, c) {
    ...
    this.getSize(), this._getMeasurements();var a, b, c;this._getOption('horizontal') ? (a = 1 / 0, b = this.size.innerHeight + this.gutter, c = 'rightwardTopToBottom') : (a = this.size.innerWidth + this.gutter, b = 1 / 0, c = 'downwardLeftToRight'), this.packer.width = this.shiftPacker.width = a, this.packer.height = this.shiftPacker.height = b, this.packer.sortDirection = this.shiftPacker.sortDirection = c, this.packer.reset(), this.maxY = 0, this.maxX = 0;
  }, j._getMeasurements = function () {
    this._getMeasurement('columnWidth', 'width'), this._getMeasurement('rowHeight', 'height'), this._getMeasurement('gutter', 'width');
  }, j._getItemLayoutPosition = function (a) {
    if (this._setRectSize(a.element, a.rect), this.isShifting || this.dragItemCount > 0) {
      var b = this._getPackMethod();this.packer[b](a.rect);
    } else this.packer.pack(a.rect);return this._setMaxXY(a.rect), a.rect;
    ...
    var d = a(b),
        e = d.outerWidth,
        f = d.outerHeight;(e || f) && (e = this._applyGridGutter(e, this.columnWidth), f = this._applyGridGutter(f, this.rowHeight)), c.width = Math.min(e, this.packer.width), c.height = Math.min(f, this.packer.height);
  }, j._applyGridGutter = function (a, b) {
    if (!b) return a + this.gutter;b += this.gutter;var c = a % b,
        d = c && 1 > c ? 'round' : 'ceil';return a = Math[d](a / b) * b;
  }, j._getContainerSize = function () {
    return this._getOption('horizontal') ? { width: this.maxX - this.gutter } : { height: this.maxY - this.gutter };
  }, j._manageStamp = function (a) {
    var b,
        d = this.getItem(a);if (d && d.isPlacing) b = d.rect;else {
      var e = this._getElementOffset(a);b = new c({ x: this._getOption('originLeft') ? e.left : e.right, y: this._getOption('originTop') ? e.top : e.bottom });
    }this._setRectSize(a, b), this.packer.placed(b), this._setMaxXY(b);
  }, j.sortItemsByPosition = function () {
    var a = this._getOption('horizontal') ? g : f;this.items.sort(a);
  }, j.fit = function (a, b, c) {
    var d = this.getItem(a);d && (this.stamp(d.element), d.enablePlacing(), this.updateShiftTargets(d), b = void 0 === b ? d.rect.x : b, c = void 0 === c ? d.rect.y : c, this.shift(d, b, c), this._bindFitEvents(d), d.moveTo(d.rect.x, d.rect.y), this.shiftLayout(), this.unstamp(d.element), this.sortItemsByPosition(), d.disablePlacing());
  }, j._bindFitEvents = function (a) {
    function b() {
      d++, 2 == d && c.dispatchEvent('fitComplete', null, [a]);
    }var c = this,
        d = 0;a.once('layout', b), this.once('layoutComplete', b);
  }, j.resize = function () {
    this.isResizeBound && this.needsResizeLayout() && (this.options.shiftPercentResize ? this.resizeShiftPercentLayout() : this.layout());
  }, j.needsResizeLayout = function () {
    var b = a(this.element),
        c = this._getOption('horizontal') ? 'innerHeight' : 'innerWidth';return b[c] != this.size[c];
    ...
    var b = this._getItemsForLayout(this.items),
        ...
        h = this[f];if (h = h && h + this.gutter) {
      this._getMeasurements();var i = this[f] + this.gutter;b.forEach(function (a) {
        var b = Math.round(a.rect[d] / h);a.rect[d] = b * i;
      });
    } else {
      var j = a(this.element)[g] + this.gutter,
          k = this.packer[e];b.forEach(function (a) {
        a.rect[d] = a.rect[d] / k * j;
      });
    }this.shiftLayout();
  }, j.itemDragStart = function (a) {
    if (this.isEnabled) {
      this.stamp(a);var b = this.getItem(a);b && (b.enablePlacing(), b.showDropPlaceholder(), this.dragItemCount++, this.updateShiftTargets(b));
    }
  }, j.updateShiftTargets = function (a) {
    this.shiftPacker.reset(), this._getBoundingRect();var b = this._getOption('originLeft'),
        d = this._getOption('originTop');this.stamps.forEach(function (a) {
      var e = this.getItem(a);if (!e || !e.isPlacing) {
        var f = this._getElementOffset(a),
            g = new c({ x: b ? f.left : f.right, y: d ? f.top : f.bottom });this._setRectSize(a, g), this.shiftPacker.placed(g);
      }
    }, this);var e = this._getOption('horizontal'),
        f = e ? 'rowHeight' : 'columnWidth',
        g = e ? 'height' : 'width';this.shiftTargetKeys = [], this.shiftTargets = [];var h,
        i = this[f];if (i = i && i + this.gutter) {
      var j = Math.ceil(a.rect[g] / i),
          k = Math.floor((this.shiftPacker[g] + this.gutter) / i);h = (k - j) * i;for (var l = 0; k > l; l++) this._addShiftTarget(l * i, 0, h);
    } else h = this.shiftPacker[g] + this.gutter - a.rect[g], this._addShiftTarget(0, 0, h);var m = this._getItemsForLayout(this.items),
        n = this._getPackMethod();m.forEach(function (a) {
      var b = a.rect;this._setRectSize(a.element, b), this.shiftPacker[n](b), this._addShiftTarget(b.x, b.y, h);var c = e ? b.x + b.width : b.x,
          d = e ? b.y : b.y + b.height;if (this._addShiftTarget(c, d, h), i) for (var f = Math.round(b[g] / i), j = 1; f > j; j++) {
        var k = e ? c : b.x + i * j,
            l = e ? b.y + i * j : d;this._addShiftTarget(k, l, h);
      }
    }, this);
  }, j._addShiftTarget = function (a, b, c) {
    var d = this._getOption('horizontal') ? b : a;if (!(0 !== d && d > c)) {
      var e = a + ',' + b,
          f = -1 != this.shiftTargetKeys.indexOf(e);f || (this.shiftTargetKeys.push(e), this.shiftTargets.push({ x: a, y: b }));
    }
  }, j.shift = function (a, b, c) {
    var d,
        e = 1 / 0,
        f = { x: b, y: c };this.shiftTargets.forEach(function (a) {
      var b = h(a, f);e > b && (d = a, e = b);
    }), a.rect.x = d.x, a.rect.y = d.y;
  };var k = 120;j.itemDragMove = function (a, b, c) {
    function d() {
      f.shift(e, b, c), e.positionDropPlaceholder(), f.layout();
    }var e = this.isEnabled && this.getItem(a);if (e) {
      b -= this.size.paddingLeft, c -= this.size.paddingTop;var f = this,
          g = new Date();this._itemDragTime && g - this._itemDragTime < k ? (clearTimeout(this.dragTimeout), this.dragTimeout = setTimeout(d, k)) : (d(), this._itemDragTime = g);
    }
  }, j.itemDragEnd = function (a) {
    function b() {
      d++, 2 == d && (c.element.classList.remove('is-positioning-post-drag'), c.hideDropPlaceholder(), e.dispatchEvent('dragItemPositioned', null, [c]));
    }var c = this.isEnabled && this.getItem(a);if (c) {
      clearTimeout(this.dragTimeout), c.element.classList.add('is-positioning-post-drag');var d = 0,
          e = this;c.once('layout', b), this.once('layoutComplete', b), c.moveTo(c.rect.x, c.rect.y), this.layout(), this.dragItemCount = Math.max(0, this.dragItemCount - 1), this.sortItemsByPosition(), c.disablePlacing(), this.unstamp(c.element);
    }
    ...
    var c = this.handleDraggabilly;a[b]('dragStart', c.dragStart), a[b]('dragMove', c.dragMove), a[b]('dragEnd', c.dragEnd);
  }, j.bindUIDraggableEvents = function (a) {
    this._bindUIDraggableEvents(a, 'on');
  }, j.unbindUIDraggableEvents = function (a) {
    this._bindUIDraggableEvents(a, 'off');
  }, j._bindUIDraggableEvents = function (a, b) {
    var c = this.handleUIDraggable;a[b]('dragstart', c.start)[b]('drag', c.drag)[b]('dragstop', c.stop);
  };var l = j.destroy;return j.destroy = function () {
  ...
  var c = a.create('packery'),
      d = c.prototype,
      e = { _getElementOffset: !0, _getMeasurement: !0 };for (var f in b.prototype) e[f] || (d[f] = b.prototype[f]);var g = d._resetLayout;d._resetLayout = function () {
    this.packer = this.packer || new b.Packer(), this.shiftPacker = this.shiftPacker || new b.Packer(), g.apply(this, arguments);
  };var h = d._getItemLayoutPosition;d._getItemLayoutPosition = function (a) {
    return a.rect = a.rect || new b.Rect(), h.call(this, a);
  };var i = d.needsResizeLayout;d.needsResizeLayout = function () {
    return this._getOption('horizontal') ? this.needsVerticalResizeLayout() : i.call(this);
  };var j = d._getOption;return d._getOption = function (a) {
...
!function (a, b) {
  ...
  function b(b) {
    ...
    function c(a) {
      ...
      f = a(b.prop('tagName') + '[data-lightbox="' + h + '"]');for (var i = 0; i < f.length; i = ++i) c(a(f[i])), f[i] === b[0] && (g = i);
    } else if ('lightbox' === b.attr('rel')) c(b);else {
      f = a(b.prop('tagName') + '[rel="' + b.attr('rel') + '"]');for (var j = 0; j < f.length; j = ++j) c(a(f[j])), f[j] === b[0] && (g = j);
            ...
            $.get('/checklogin', function (data) {
                ...
                if (data == "1") {
                    $.ajax({
                        ...
                        type: 'post',
                        dataType: 'text',
                        data: {content: cm, news: $('#news_id').val()},
